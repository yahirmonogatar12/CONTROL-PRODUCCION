...
class ApiService {
  ...
  static Future<Map<String, dynamic>> endAudit(int auditId, int endedBy) async {
    try {
      final response = await http.post(
  ...
  static Future<Map<String, dynamic>> auditScanLocation({
    ...
    try {
      final response = await http.post(
        ...
        headers: {'Content-Type': 'application/json'},
        // Nota: el backend usa "usuario" y no "scannedBy".
        // Este payload se mantiene por compatibilidad con implementaciones previas.
        body: json.encode({
          'auditId': auditId,
          'location': location,
          'scannedBy': scannedBy,
