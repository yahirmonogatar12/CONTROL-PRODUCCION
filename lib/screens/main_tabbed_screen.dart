...
import 'package:control_produccion_flutter/core/widgets/language_selector.dart';
...
import 'package:control_produccion_flutter/screens/material_produccion/material_produccion_screen.dart';
import 'package:control_produccion_flutter/screens/material_outgoing/material_outgoing_screen.dart';
import 'package:control_produccion_flutter/screens/long_term_inventory/long_term_inventory_screen.dart';
import 'package:control_produccion_flutter/screens/material_control/material_control_screen.dart';
import 'package:control_produccion_flutter/screens/user_management/user_management_screen.dart';
import 'package:control_produccion_flutter/screens/material_return/material_return_screen.dart';
import 'package:control_produccion_flutter/screens/material_requirements/material_requirements_screen.dart';
import 'package:control_produccion_flutter/screens/reentry/reentry_screen.dart';
import 'package:control_produccion_flutter/screens/location_search/location_search_screen.dart';
import 'package:control_produccion_flutter/screens/inventory_audit/inventory_audit_screen.dart';
import 'package:control_produccion_flutter/screens/material_shortage/material_shortage_screen.dart';
import 'package:control_produccion_flutter/screens/pcb_entrada/pcb_entrada_screen.dart';
import 'package:control_produccion_flutter/screens/pcb_salida/pcb_salida_screen.dart';
import 'package:control_produccion_flutter/screens/pcb_inventario/pcb_inventario_screen.dart';
import 'package:control_produccion_flutter/screens/scrap/scrap_screen.dart';
import 'package:control_produccion_flutter/screens/scrap_motivos/scrap_motivos_screen.dart';
import 'dart:async';
...
class _MainTabbedScreenState extends State<MainTabbedScreen> {
  ...
  final GlobalKey<MaterialProduccionScreenState> _warehousingScreenKey =
      GlobalKey();
  ...
  void _buildVisibleTabs() {
    ...
    // Control de Scrap - áreas SMD/IMD/Assy/Componente/Mantenimiento + full access
    ...
    // Motivos de Scrap - solo full access (Sistemas/Gerencia/Administracion)
  ...
  Widget _buildTabContent(String key, String currentLocale) {
    switch (key) {
      case 'produccion':
        return MaterialProduccionScreen(
...
class _TopTabBarDynamic extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          // Tabs dinámicos - scrollable para evitar overflow
          Expanded(
            ...
            PopupMenuButton<String>(
              ...
              onSelected: (value) {
                if (value == 'change_password') {
                  ...
                  _showLogoutConfirmation(context, tr, onLogout);
                }
              },
              itemBuilder: (context) => [
                PopupMenuItem(
