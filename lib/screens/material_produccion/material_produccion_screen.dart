...
import 'produccion_search_bar_panel.dart';
import 'produccion_grid_panel.dart';
import 'produccion_edit_panel.dart';
import 'produccion_multi_edit_dialog.dart'; // Contiene WarehousingMultiEditPanel
import 'produccion_outgoing_confirm_panel.dart';
import 'produccion_form_panel.dart';

class MaterialProduccionScreen extends StatefulWidget {
  final LanguageProvider languageProvider;
  
  const MaterialProduccionScreen({super.key, required this.languageProvider});

  @override
  State<MaterialProduccionScreen> createState() => MaterialProduccionScreenState();
}

class MaterialProduccionScreenState extends State<MaterialProduccionScreen> with SingleTickerProviderStateMixin {
  final GlobalKey<ProduccionGridPanelState> _gridKey = GlobalKey();
  final GlobalKey<ProduccionOutgoingConfirmPanelState> _warehouseOutgoingPanelKey = GlobalKey();
  final GlobalKey<ProduccionFormPanelState> _formPanelKey = GlobalKey();
            ...
            children: [
              if (canConfirmWarehouseOutgoing) ...[
                ...
                if (_useManualForm)
                  ...
                  ProduccionOutgoingConfirmPanel(
              ...
              Row(
                children: [
                  Expanded(
                    child: ProduccionSearchBarPanel(
                      languageProvider: widget.languageProvider,
                      onSearch: _onSearch,
                      gridKey: _gridKey,
                    ),
              ...
              Expanded(child: ProduccionGridPanel(
                key: _gridKey,
                languageProvider: widget.languageProvider,
