...
class ProduccionGridPanel extends StatefulWidget {
  ...
  @override
  State<ProduccionGridPanel> createState() => ProduccionGridPanelState();
}

class ProduccionGridPanelState extends State<ProduccionGridPanel> with AutomaticKeepAliveClientMixin {
