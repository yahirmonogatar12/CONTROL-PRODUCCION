...
class ProduccionOutgoingConfirmPanel extends StatefulWidget {
  final LanguageProvider languageProvider;
  final VoidCallback? onConfirmed;
  final ValueChanged<int>? onCountChanged;

  const ProduccionOutgoingConfirmPanel({
    super.key,
  ...
  @override
  State<ProduccionOutgoingConfirmPanel> createState() => ProduccionOutgoingConfirmPanelState();
}

class ProduccionOutgoingConfirmPanelState extends State<ProduccionOutgoingConfirmPanel> {
