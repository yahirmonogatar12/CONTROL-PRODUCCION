...
class ProduccionEditPanel extends StatefulWidget {
  final LanguageProvider languageProvider;
  final Map<String, dynamic> rowData;
  final VoidCallback onClose;
  final VoidCallback onSaved;
  
  const ProduccionEditPanel({
    super.key,
  ...
  @override
  State<ProduccionEditPanel> createState() => _ProduccionEditPanelState();
}

class _ProduccionEditPanelState extends State<ProduccionEditPanel> {
