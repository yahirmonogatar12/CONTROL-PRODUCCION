...
**Control de Produccion System** - Sistema de gestión de almacén de materiales para entornos de manufactura. Disponible en versión Desktop (Windows) y Mobile (Android/iOS).
...
|--------|-------------|-------------------------|
| **Control Produccion** | Recepción y registro de material | Almacén, Sistemas, Gerencia |
