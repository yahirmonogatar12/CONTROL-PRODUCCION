...
|----------------|-------------|----------------|
| `write_produccion` | Entrada de material | ✅ Entry |
...
| Warehousing | `GET /api/produccion/by-code/:code` | ✅ Buscar material |
| Warehousing | `GET /api/produccion/search` | ✅ Entradas recientes |
