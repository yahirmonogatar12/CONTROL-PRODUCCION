...
```
lib/screens/material_produccion/
...
|--------|----------|-------------|
| GET | `/api/produccion` | Lista todas las entradas |
| GET | `/api/produccion/search` | Buscar con filtros |
| GET | `/api/produccion/by-code/:code` | Buscar por código |
| GET | `/api/produccion/:id` | Obtener por ID |
| POST | `/api/produccion` | Crear nueva entrada |
| PUT | `/api/produccion/:id` | Actualizar entrada |
| DELETE | `/api/produccion/:id` | Eliminar entrada |

### Parámetros de Búsqueda

```
GET /api/produccion/search?
...
```dart
// Títulos
'material_warehousing': 'Control Produccion' / 'Entrada de Material' / '자재 입고',
