...
exports.getAvailablePermissions = async (req, res, next) => {
  try {
    const permissions = [
      ...
      { key: 'view_pcb_entrada', name: 'Ver PCB Entrada', category: 'Inventario PCB', description: 'Puede ver el modulo de entrada de PCBs' },
      { key: 'view_pcb_salida', name: 'Ver PCB Salida', category: 'Inventario PCB', description: 'Puede ver el modulo de salida de PCBs' },
