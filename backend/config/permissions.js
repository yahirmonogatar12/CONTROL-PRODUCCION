...
// Departamentos con permiso de escritura en Produccion (entrada de material)
const Produccion_WRITE_DEPARTMENTS = [...FULL_ACCESS_DEPARTMENTS, 'Almacén', 'Almacén Supervisor'];
