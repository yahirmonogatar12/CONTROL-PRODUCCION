/**
 * Script para agregar columnas de Reingreso a la tabla control_material_almacen_prod
  ...
  const alterStatements = [
    {
      ...
      sql: `ALTER TABLE control_material_almacen_prod ADD COLUMN fecha_reingreso DATETIME NULL`,
      description: 'Fecha/hora del último reingreso'
    },
    {
      name: 'ubicacion_anterior',
      sql: `ALTER TABLE control_material_almacen_prod ADD COLUMN ubicacion_anterior VARCHAR(100) NULL`,
      description: 'Ubicación antes del reingreso'
    },
    {
      name: 'usuario_reingreso',
      sql: `ALTER TABLE control_material_almacen_prod ADD COLUMN usuario_reingreso VARCHAR(100) NULL`,
