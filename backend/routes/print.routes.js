...
function getConfigFilePath() {
  ...
  // En ejecutable pkg, usar la carpeta del .exe
  if (process.pkg) {
    return path.join(path.dirname(process.execPath), 'printer_config.json');
  }

  // En desarrollo, usar el directorio actual del proceso
  return path.join(process.cwd(), 'printer_config.json');
}
