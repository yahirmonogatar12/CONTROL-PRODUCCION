-- ============================================
-- TABLA: control_material_almacen_prod (ENTRADAS)
-- ============================================
...
CREATE INDEX idx_receiving_lot_code ON control_material_almacen_prod(receiving_lot_code);

-- Índice para búsquedas por estado IQC
CREATE INDEX idx_iqc_status ON control_material_almacen_prod(iqc_status);
*/

-- ============================================
-- TABLA: iqc_inspection_lot_prod (Inspecciones IQC por Lote)
-- ============================================
CREATE TABLE IF NOT EXISTS iqc_inspection_lot_prod (
  ...
  sample_label_id INT NULL,                          -- FK a control_material_almacen_prod
  ...
  -- Foreign Keys
  FOREIGN KEY (sample_label_id) REFERENCES control_material_almacen_prod(id) ON DELETE SET NULL,
...
-- ============================================
-- TABLA: iqc_inspection_detail_prod (Detalle de Mediciones)
-- ============================================
CREATE TABLE IF NOT EXISTS iqc_inspection_detail_prod (
  id INT AUTO_INCREMENT PRIMARY KEY,
  
  -- Relación con inspección
  inspection_lot_id INT NOT NULL,                    -- FK a iqc_inspection_lot_prod
  ...
  -- Foreign Key
  FOREIGN KEY (inspection_lot_id) REFERENCES iqc_inspection_lot_prod(id) ON DELETE CASCADE,
...
-- ============================================
-- TABLA: material_return_prod (Devolución de Material)
-- ============================================
CREATE TABLE IF NOT EXISTS material_return_prod (
  id INT AUTO_INCREMENT PRIMARY KEY,
  
  -- Referencia a la entrada original
  warehousing_id INT NULL,                           -- FK a control_material_almacen_prod
