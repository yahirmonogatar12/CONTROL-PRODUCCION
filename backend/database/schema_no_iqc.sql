...
CREATE TABLE IF NOT EXISTS control_material_almacen_prod (
...
CREATE TABLE IF NOT EXISTS material_return_prod (
  id INT AUTO_INCREMENT PRIMARY KEY,
  ...
  FOREIGN KEY (warehousing_id) REFERENCES control_material_almacen_prod(id) ON DELETE SET NULL,
...
-- ALTER TABLE control_material_entrada_prod ADD COLUMN confirmado TINYINT DEFAULT 0;
-- ALTER TABLE control_material_entrada_prod ADD COLUMN confirmado_por VARCHAR(150) NULL;
-- ALTER TABLE control_material_entrada_prod ADD COLUMN confirmado_at DATETIME NULL;
-- ALTER TABLE control_material_entrada_prod ADD COLUMN rechazado TINYINT DEFAULT 0;
-- ALTER TABLE control_material_entrada_prod ADD COLUMN rechazado_por VARCHAR(150) NULL;
-- ALTER TABLE control_material_entrada_prod ADD COLUMN rechazado_at DATETIME NULL;
-- ALTER TABLE control_material_entrada_prod ADD COLUMN rechazado_motivo TEXT NULL;

-- Si control_material_almacen_prod ya existe, agregar columnas faltantes:
-- ALTER TABLE control_material_almacen_prod ADD COLUMN vendedor VARCHAR(100) NULL;
-- ALTER TABLE control_material_almacen_prod ADD COLUMN usuario_registro VARCHAR(150) NULL;
-- ALTER TABLE control_material_almacen_prod ADD COLUMN unidad_medida VARCHAR(10) NULL;
