...
# Configuración
$ProjectName = "Control_produccion"
$AppName = "Control de Produccion"
$Publisher = "MES"
...
WshShell.Run "Control_produccion.exe", 1, False
...
taskkill /F /IM Control_produccion.exe 2>nul
...
#define MyAppExeName "Control_produccion.exe"
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\Iniciar.vbs"; IconFilename: "{app}\Control_produccion.exe"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\Iniciar.vbs"; IconFilename: "{app}\Control_produccion.exe"; Tasks: desktopicon
...
[UninstallRun]
Filename: "{app}\Detener.bat"; Flags: runhidden
"@
